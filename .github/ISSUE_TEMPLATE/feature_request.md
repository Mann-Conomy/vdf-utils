...
about: "Request a new change or feature for the vdf-utils library"
title: "[FEATURE] - "
labels: ["enhancement"]
---
...
If applicable, provide an example of how the new feature or improvement would be configured in the VDF class.
...
export class VDF {
    ...
    static async equals(source: string, target: object): boolean {
        const result = VDF.parse(source);
        return isEqual(result, target);
    }
}
```
